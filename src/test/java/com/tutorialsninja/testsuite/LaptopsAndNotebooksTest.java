...
public class LaptopsAndNotebooksTest extends TestBase {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        laptopsAndNotebooksPage.enterEmail("Abc123@gmail.com");
        laptopsAndNotebooksPage.enterPhoneNumber("01234567890");
        laptopsAndNotebooksPage.enterAddress1("12 High street");
        laptopsAndNotebooksPage.enterCity("Luton");
        laptopsAndNotebooksPage.enterPostCode("LU4 9LJ");
        laptopsAndNotebooksPage.selectCountry("United Kingdom");
        laptopsAndNotebooksPage.selectRegion("Bedfordshire");
